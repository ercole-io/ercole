...
type OracleChangesDto struct {
	Hostname      string             `json:"hostname" bson:"hostname"`
	Databasenames []OracleChangesDBs `json:"oracleChangesDBs" bson:"oracleChangesDBs"`
}

type OracleChangesDBs struct {
	Databasename  string                `json:"databasename" bson:"databasename"`
	OracleChanges []OracleChangesGrowth `json:"oracleChanges" bson:"oracleChanges"`
}

type OracleChangesGrowth struct {
