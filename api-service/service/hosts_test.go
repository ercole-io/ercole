...
func TestSearchHostsAsXLSX(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		assert.Equal(t, "latest", sp.GetCellValue("Hosts", "E2"))
		assert.Equal(t, utils.P("2020-07-01T09:18:03.715+02:00").Local().String(), sp.GetCellValue("Hosts", "F2"))
		assert.Equal(t, "", sp.GetCellValue("Hosts", "G2"))
		assert.Equal(t, "Red Hat Enterprise Linux 7.6", sp.GetCellValue("Hosts", "H2"))
		assert.Equal(t, "Linux 4.1.12-124.26.12.el7uek.x86_64", sp.GetCellValue("Hosts", "I2"))
		assert.Equal(t, "true", sp.GetCellValue("Hosts", "J2"))
		assert.Equal(t, "false", sp.GetCellValue("Hosts", "K2"))
		assert.Equal(t, "false", sp.GetCellValue("Hosts", "L2"))
		assert.Equal(t, "Bare metal", sp.GetCellValue("Hosts", "M2"))
		assert.Equal(t, "Bare metal", sp.GetCellValue("Hosts", "N2"))
		assert.Equal(t, "48", sp.GetCellValue("Hosts", "O2"))
		assert.Equal(t, "24", sp.GetCellValue("Hosts", "P2"))
		...
		assert.Equal(t, "Intel(R) Xeon(R) Platinum 8160 CPU @ 2.10GHz", sp.GetCellValue("Hosts", "T2"))
		...
		assert.Equal(t, "latest", sp.GetCellValue("Hosts", "E3"))
		assert.Equal(t, utils.P("2020-07-01T09:18:03.726+02:00").Local().String(), sp.GetCellValue("Hosts", "F3"))
		assert.Equal(t, "", sp.GetCellValue("Hosts", "G3"))
		assert.Equal(t, "Red Hat Enterprise Linux 7.6", sp.GetCellValue("Hosts", "H3"))
		assert.Equal(t, "Linux 3.10.0-514.el7.x86_64", sp.GetCellValue("Hosts", "I3"))
		assert.Equal(t, "false", sp.GetCellValue("Hosts", "J3"))
		assert.Equal(t, "false", sp.GetCellValue("Hosts", "K3"))
		assert.Equal(t, "false", sp.GetCellValue("Hosts", "L3"))
		assert.Equal(t, "VIRT", sp.GetCellValue("Hosts", "M3"))
		assert.Equal(t, "VMWARE", sp.GetCellValue("Hosts", "N3"))
		assert.Equal(t, "2", sp.GetCellValue("Hosts", "O3"))
		assert.Equal(t, "1", sp.GetCellValue("Hosts", "P3"))
		assert.Equal(t, "2", sp.GetCellValue("Hosts", "Q3"))
		assert.Equal(t, "3", sp.GetCellValue("Hosts", "R3"))
		assert.Equal(t, "1", sp.GetCellValue("Hosts", "S3"))
		assert.Equal(t, "Intel(R) Xeon(R) CPU           E5630  @ 2.53GHz", sp.GetCellValue("Hosts", "T3"))
	})
