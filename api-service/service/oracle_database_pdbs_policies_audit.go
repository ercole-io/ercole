...
func (as *APIService) GetOracleDatabasePdbPoliciesAuditFlag(hostname, dbname, pdbname string) (string, error) {
	policiesAudit, err := as.Database.FindOracleDatabasePdbPoliciesAudit(hostname, dbname, pdbname)
	if err != nil {
		return "", err
	}
