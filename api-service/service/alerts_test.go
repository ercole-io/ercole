...
// TODO: ambiguous error occurred. Look at https://github.com/golang/mock/issues/190 for updates
...
// 	db.EXPECT().SearchAlerts(alertFilter).Return(expectedRes, nil).AnyTimes()
