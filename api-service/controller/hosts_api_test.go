...
func TestSearchHosts_XLSXSuccess(t *testing.T) {
	...
	assert.Equal(t, utils.P("2020-04-15T08:46:58.461+02:00").String(), sh.Cell(6, 1).String())
	...
	assert.Equal(t, utils.P("2020-04-15T08:46:58.471+02:00").String(), sh.Cell(6, 2).String())
