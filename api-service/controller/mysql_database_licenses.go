...
func (ctrl *APIController) UpdateMySqlLicenseIgnoredField(w http.ResponseWriter, r *http.Request) {
	...
	//set the value
	err = ctrl.Service.UpdateMySqlLicenseIgnoredField(hostname, dbname, ignored, req.IgnoredComment)
	if err != nil {
