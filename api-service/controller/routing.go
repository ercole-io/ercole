...
func setupProtectedRoutes(router *mux.Router, ctrl APIControllerInterface) {
	...
	router.HandleFunc("/hosts/technologies/oracle/databases/consumed-licenses", ctrl.SearchOracleDatabaseConsumedLicenses).Methods("GET")
...
func setupSettingsRoutes(router *mux.Router, ctrl APIControllerInterface) {
	...
	router.HandleFunc("/oracle/database/agreements-parts", ctrl.GetOracleDatabaseAgreementPartsList).Methods("GET")
}
