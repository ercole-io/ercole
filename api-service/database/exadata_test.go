...
func (m *MongodbSuite) TestSearchExadata() {
	...
	m.T().Run("should_filter_out_by_environment", func(t *testing.T) {
		out, err := m.db.SearchExadata(false, []string{""}, "", false, -1, -1, "", "FOOBAR", utils.MAX_TIME)
	...
	m.T().Run("should_filter_out_by_location", func(t *testing.T) {
		out, err := m.db.SearchExadata(false, []string{""}, "", false, -1, -1, "France", "", utils.MAX_TIME)
		m.Require().NoError(err)
		var expectedOut interface{} = []interface{}{}
	...
	m.T().Run("should_filter_out_by_older_than", func(t *testing.T) {
		out, err := m.db.SearchExadata(false, []string{""}, "", false, -1, -1, "", "", utils.P("1999-05-04T16:09:46.608+02:00"))
		m.Require().NoError(err)
		var expectedOut interface{} = []interface{}{}
	...
	m.T().Run("should_search_return_anything", func(t *testing.T) {
		out, err := m.db.SearchExadata(false, []string{"foobar"}, "", false, -1, -1, "", "", utils.MAX_TIME)
		m.Require().NoError(err)
		var expectedOut interface{} = []interface{}{}
	...
	m.T().Run("should_be_paging", func(t *testing.T) {
		out, err := m.db.SearchExadata(false, []string{}, "", false, 0, 1, "", "", utils.MAX_TIME)
		m.Require().NoError(err)
	...
	m.T().Run("should_search_test_exadata", func(t *testing.T) {
		out, err := m.db.SearchExadata(false, []string{"test-exadata", "s75-c2449b0e89e5a0b38401636eaa07abd5"}, "", false, -1, -1, "", "", utils.MAX_TIME)
		m.Require().NoError(err)
		var expectedOut interface{} = []interface{}{
			map[string]interface{}{
				"CreatedAt": utils.P("2020-05-12T10:39:44.831+02:00").Local(),
	...
	m.T().Run("fullmode", func(t *testing.T) {
		out, err := m.db.SearchExadata(true, []string{}, "", false, -1, -1, "", "", utils.MAX_TIME)
		m.Require().NoError(err)
		var expectedOut interface{} = []interface{}{
			map[string]interface{}{
