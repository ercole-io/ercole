	...
	m.T().Run("fullmode", func(t *testing.T) {
		...
		var expectedOut interface{} = []interface{}{
			map[string]interface{}{
				...
				"FeatureUsageStats": []interface{}{
					map[string]interface{}{
						...
						"ExtraFeatureInfo": "",
						"Feature":          "ADDM",
						"FirstUsageDate":   utils.P("2019-06-24T19:34:20+02:00"),
						"LastUsageDate":    utils.P("2019-11-09T05:48:23+01:00"),
					...
					map[string]interface{}{
						...
						"ExtraFeatureInfo": "",
						"Feature":          "AWR Report",
						"FirstUsageDate":   utils.P("2019-06-27T17:15:44+02:00"),
						"LastUsageDate":    utils.P("2019-11-09T05:48:23+01:00"),
						"Product":          "Diagnostics Pack",
					},
					map[string]interface{}{
						...
						"FirstUsageDate":   utils.P("2019-06-27T19:01:09+02:00"),
						"LastUsageDate":    utils.P("2019-07-02T07:35:05+02:00"),
						"Product":          "Diagnostics Pack",
					},
				},
				"HA":             false,
			...
			map[string]interface{}{
				...
				"CPUCount":      2,
				"Charset":       "AL32UTF8",
				"CreatedAt":     utils.P("2020-05-06T13:39:23.259+02:00"),
				"DBTime":        184.81,
				"DailyCPUUsage": 0.7,
				"DatafileSize":  6,
				"Dataguard":     true,
