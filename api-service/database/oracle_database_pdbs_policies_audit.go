...
func (md *MongoDatabase) FindOracleDatabasePdbPoliciesAudit(hostname, dbname, pdbname string) (*dto.OraclePoliciesAudit, error) {
	ctx := context.TODO()
...
func (md *MongoDatabase) ListOracleDatabasePdbPoliciesAudit() ([]dto.OraclePdbPoliciesAuditListResponse, error) {
	ctx := context.TODO()
						...
						Value: bson.D{
							{Key: "$cond",
								Value: bson.A{
										...
										{Key: "$and",
											Value: bson.A{
												bson.D{
													{Key: "$ne",
														Value: bson.A{
															bson.D{{Key: "$type", Value: "$features.oracle.database.databases.pdbs.policiesAudit"}},
															"missing",
														},
													},
												},
												...
												bson.D{
													{Key: "$gt",
														Value: bson.A{
															bson.D{{Key: "$size", Value: "$features.oracle.database.databases.pdbs.policiesAudit"}},
															0,
														},
													},
												},
									...
									"$features.oracle.database.databases.pdbs.policiesAudit",
									bson.A{},
								},
							},
						},
	...
	result := make([]dto.OraclePdbPoliciesAuditListResponse, 0)
