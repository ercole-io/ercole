...
func (job *OciDataRetrieveJob) GetOciCompartments(profiles []string) ([]model.OciCompartment, error) {
	var merr error

	var listCompartments []model.OciCompartment

	// retrieve data for configurated profiles
	dbProfiles, err := job.Database.GetMapOciProfiles()
	if err != nil {
		return nil, err
	}
...
func (job *OciDataRetrieveJob) getOciProfileCompartments(tenancyOCID string, customConfigProvider common.ConfigurationProvider) ([]model.OciCompartment, error) {
	var merr error
...
func (job *OciDataRetrieveJob) getOciCustomConfigProviderAndTenancy(profileId string) (common.ConfigurationProvider, string, error) {
	var merr error
