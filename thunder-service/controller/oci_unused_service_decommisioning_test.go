...
func TestGetOciUnusedServiceDecommisioning_StatusNotFound(t *testing.T) {
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedServiceDecommisioning(strProfiles).Return(nil, utils.ErrClusterNotFound)

		rr := httptest.NewRecorder()
		handler := http.HandlerFunc(ac.GetOciUnusedServiceDecommisioning)

		req, err := http.NewRequest("GET", "/oracle-cloud/unused-service-decommisioning", nil)
...
func TestGetOciUnusedServiceDecommisioning_InternalServerError(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		var strProfiles = []string{"6140c473413cf9de756f9848"}
		as.EXPECT().GetOciUnusedServiceDecommisioning(strProfiles).Return(nil, errMock)
...
func TestGetOciUnusedServiceDecommisioning_BadRequest(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestGetOciUnusedServiceDecommisioning_InvalidProfileId(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedServiceDecommisioning(strProfiles).Return(nil, utils.ErrInvalidProfileId)
...
func TestGetOciUnusedServiceDecommisioning_PartialContent(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedServiceDecommisioning(strProfiles).Return(recommendations, mockError)
...
func TestGetOciUnusedServiceDecommisioning_Success(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("Success", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedServiceDecommisioning(strProfiles).Return(expectedRes, nil)
