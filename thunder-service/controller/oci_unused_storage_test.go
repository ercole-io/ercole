...
func TestGetOciUnusedStorage_StatusNotFound(t *testing.T) {
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedStorage(strProfiles).Return(nil, utils.ErrClusterNotFound)
...
func TestGetOciUnusedStorage_InternalServerError(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		var strProfiles = []string{"6140c473413cf9de756f9848"}
		as.EXPECT().GetOciUnusedStorage(strProfiles).Return(nil, errMock)
...
func TestGetOciUnusedStorage_BadRequest(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestGetOciUnusedStorage_InvalidProfileId(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedStorage(strProfiles).Return(nil, utils.ErrInvalidProfileId)
...
func TestGetOciUnusedStorage_PartialContent(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedStorage(strProfiles).Return(recommendations, mockError)
...
func TestGetOciUnusedStorage_Success(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("Success", func(t *testing.T) {
		...
		as.EXPECT().GetOciUnusedStorage(strProfiles).Return(expectedRes, nil)
