...
func TestGetOciSISRightsizing_StatusNotFound(t *testing.T) {
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		as.EXPECT().GetOciSISRightsizing(strProfiles).Return(nil, utils.ErrClusterNotFound)

		rr := httptest.NewRecorder()
		handler := http.HandlerFunc(ac.GetOciSISRightsizing)

		req, err := http.NewRequest("GET", "/oracle-cloud/sis-rightsizing", nil)
...
func TestGetOciSISRightsizing_InternalServerError(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		var strProfiles = []string{"6140c473413cf9de756f9848"}
		as.EXPECT().GetOciSISRightsizing(strProfiles).Return(nil, errMock)
...
func TestGetOciSISRightsizing_BadRequest(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestGetOciSISRightsizing_InvalidProfileId(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciSISRightsizing(strProfiles).Return(nil, utils.ErrInvalidProfileId)
...
func TestGetOciSISRightsizing_PartialContent(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciSISRightsizing(strProfiles).Return(recommendations, mockError)
...
func TestGetOciSISRightsizing_Success(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("Success", func(t *testing.T) {
		...
		as.EXPECT().GetOciSISRightsizing(strProfiles).Return(expectedRes, nil)
