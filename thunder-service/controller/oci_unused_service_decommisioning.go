...
func (ctrl *ThunderController) GetOciUnusedServiceDecommisioning(w http.ResponseWriter, r *http.Request) {
	...
	recommendations, err := ctrl.Service.GetOciUnusedServiceDecommisioning(profiles)
