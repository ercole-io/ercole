...
func TestGetOciObjectStorageOptimization_StatusNotFound(t *testing.T) {
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		as.EXPECT().GetOciObjectStorageOptimization(strProfiles).Return(nil, utils.ErrClusterNotFound)

		rr := httptest.NewRecorder()
		handler := http.HandlerFunc(ac.GetOciObjectStorageOptimization)

		req, err := http.NewRequest("GET", "/oracle-cloud/object-storage-optimization", nil)
...
func TestGetOciObjectStorageOptimization_InternalServerError(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("StatusNotFound", func(t *testing.T) {
		...
		var strProfiles = []string{"6140c473413cf9de756f9848"}
		as.EXPECT().GetOciObjectStorageOptimization(strProfiles).Return(nil, errMock)
...
func TestGetOciObjectStorageOptimization_BadRequest(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
...
func TestGetOciObjectStorageOptimization_InvalidProfileId(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciObjectStorageOptimization(strProfiles).Return(nil, utils.ErrInvalidProfileId)
...
func TestGetOciObjectStorageOptimization_PartialContent(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("BadRequest", func(t *testing.T) {
		...
		as.EXPECT().GetOciObjectStorageOptimization(strProfiles).Return(recommendations, mockError)
...
func TestGetOciObjectStorageOptimization_Success(t *testing.T) {
	mockCtrl := gomock.NewController(t)
	defer mockCtrl.Finish()
	...
	t.Run("Success", func(t *testing.T) {
		...
		as.EXPECT().GetOciObjectStorageOptimization(strProfiles).Return(expectedRes, nil)
