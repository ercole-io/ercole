...
func (ctrl *ThunderController) GetOciBlockStorageRightsizing(w http.ResponseWriter, r *http.Request) {
	...
	recommendations, err := ctrl.Service.GetOciBlockStorageRightsizing(profiles)
