...
func (ctrl *ThunderController) GetOciComputeInstancesIdle(w http.ResponseWriter, r *http.Request) {
	...
	recommendations, err := ctrl.Service.GetOciComputeInstancesIdle(profiles)
