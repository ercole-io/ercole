...
func init() {
	getDatabaseHighReliabilityStatsCmd := simpleAPIRequestCommand("high-reliability-status",
	...
	statsDatabasesOracleCmd.AddCommand(getDatabaseHighReliabilityStatsCmd)
}
