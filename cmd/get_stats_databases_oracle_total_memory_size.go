...
func init() {
	getDatabaseTotalMemorySizeStatsCmd := simpleSingleValueAPIRequestCommand("total-memory-size",
	...
	statsDatabasesOracleCmd.AddCommand(getDatabaseTotalMemorySizeStatsCmd)
}
