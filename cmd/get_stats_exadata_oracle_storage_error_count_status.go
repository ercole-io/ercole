...
func init() {
	GetOracleExadataStorageErrorCountStatusStatsCmd := simpleAPIRequestCommand("storage-error-count-status",
	...
	statsExadataCmd.AddCommand(GetOracleExadataStorageErrorCountStatusStatsCmd)
}
