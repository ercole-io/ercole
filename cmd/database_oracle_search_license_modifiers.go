...
func init() {
	SearchOracleDatabaseLicenseModifiersCmd := simpleAPIRequestCommand("search-license-modifiers",
	...
	databaseOracleCmd.AddCommand(SearchOracleDatabaseLicenseModifiersCmd)
}
