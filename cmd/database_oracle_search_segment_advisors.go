...
func init() {
	SearchOracleDatabaseSegmentAdvisorsCmd := simpleAPIRequestCommand("search-segment-advisors",
	...
	databaseOracleCmd.AddCommand(SearchOracleDatabaseSegmentAdvisorsCmd)
}
