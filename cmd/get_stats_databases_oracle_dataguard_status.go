...
func init() {
	GetOracleDatabaseDataguardStatusStatsCmd := simpleAPIRequestCommand("dataguard-status",
	...
	statsDatabasesOracleCmd.AddCommand(GetOracleDatabaseDataguardStatusStatsCmd)
}
