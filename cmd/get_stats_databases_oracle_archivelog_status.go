...
func init() {
	GetOracleDatabaseArchivelogStatusStatsCmd := simpleAPIRequestCommand("archivelog-status",
	...
	statsDatabasesOracleCmd.AddCommand(GetOracleDatabaseArchivelogStatusStatsCmd)
}
